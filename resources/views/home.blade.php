        ...
        <div class="col-md-4">
            <div class="product-card mb-30">
                ...
                <div class="product-badge bg-nuevo border-default text-body">{{ $producto->precio }} Bs.</div>
                  ...
                  <ul class=" row justify-content-center product-image--list">
                      <li class="item-selected">
                          <img src="http://ecx.images-amazon.com/images/I/71f3p1o62FL._SX522_.jpg" class="product-image--item"/>
                      </li>
                ...
                <div class="product-">
                    ...
                    <h3 class="product-title"><a href="#" data-abc="true" > {{ $producto->descripcion }}</a></h3>
                        <div>
